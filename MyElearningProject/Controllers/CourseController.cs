...
//                =(from x in context.Categories.ToList()  select new SelectListItem
//                {
//                    Text = x.CategoryName,
...
//        }
//        [HttpPost]
//        public ActionResult CreateCourse(CourseController course)
//        {
...
//        {
//            List<SelectListItem> categories
//               = (from x in context.Categories.ToList()
//                  select new SelectListItem
//                  {
//                      Text = x.CategoryName,
//                      Value = x.CategoryID.ToString()
